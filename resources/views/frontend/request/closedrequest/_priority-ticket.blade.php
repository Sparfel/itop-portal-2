    ...
    <div class="card-header">
        ...
        <div class="card-tools">
            ...
            @elseif ((request('request_type') && request('request_type') !== 'all')
                    || (request('resolution_code') && request('resolution_code') !== 'all'))
    ...
    <div class="card-footer p-0">
        <ul class="nav nav-pills flex-column">
            <li class="nav-item active">
                <a href="{{ route('closedrequest.filter', ['priority' => 'all', 'request_type' => request('request_type', 'all'), 'resolution_code' => request('resolution_code', 'all')]) }}" class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('closedrequest.filter', ['priority' => 1, 'request_type' => request('request_type', 'all'), 'resolution_code' => request('resolution_code', 'all')]) }}" class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('closedrequest.filter', ['priority' => 2, 'request_type' => request('request_type', 'all'), 'resolution_code' => request('resolution_code', 'all')]) }}" class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('closedrequest.filter', ['priority' => 3, 'request_type' => request('request_type', 'all'), 'resolution_code' => request('resolution_code', 'all')]) }}" class="nav-link">
            ...
            <li class="nav-item">
                <a href="{{ route('closedrequest.filter', ['priority' => 4, 'request_type' => request('request_type', 'all'), 'status' => request('status', 'all')]) }}" class="nav-link">
